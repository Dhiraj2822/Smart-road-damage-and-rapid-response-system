...
export default function TimelineComponent({ complaintId, trigger, initialData }) {
  ...
  if (history.length === 0) return <Typography color="textSecondary" sx={{ mt: 2, p: 2 }}>No activity history found for this complaint.</Typography>;
              ...
              <StepLabel>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, flexWrap: "wrap" }}>
                  ...
                  <Typography variant="caption" color="textSecondary" sx={{ fontWeight: 500 }}>
                    {ts ? ts.toLocaleString("en-IN") : "Date unknown"}
                  </Typography>
                </Box>
              </StepLabel>
              <StepContent>
